...
public class CajaIn {
    ...
    public CajaIn(String _id, String cod_barra_caja, int idsede, String sede, int idlocal, String local, int tipo, int acl, int dia, int mes, int anio, int hora, int min, int seg, int subido) {
        this._id = _id;
